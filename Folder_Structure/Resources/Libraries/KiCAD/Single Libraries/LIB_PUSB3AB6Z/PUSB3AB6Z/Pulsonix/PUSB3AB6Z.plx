...
(library Library_1
	...
	(patternDef "PUSB3AB6Z" (originalName "PUSB3AB6Z")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.55 1.063) (pt 0.55 1.063) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.55 1.063) (pt 0.55 -1.063) (width 0.025))
		)
	...
	(compDef "PUSB3AB6Z" (originalName "PUSB3AB6Z") (compHeader (numPins 7) (numParts 1) (refDesPrefix D)
		...
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/PUSB3AB6.pdf")
		(attr "<Component Height>" "0.5")
		(attr "<STEP Filename>" "PUSB3AB6Z.stp")
		(attr "<STEP Offsets>" "X=-1.42;Y=0.79;Z=1.05")
